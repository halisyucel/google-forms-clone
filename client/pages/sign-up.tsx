...
const SignUp = () => {
    ...
    return (
        <GoogleCardLayout
            containerClassName={styles.sign_up__container}
            loading={loading}
        >
            <Helmet>
            ...
            <CardContent className={styles.sign_up__content}>
                ...
                <div className={styles.sign_up__content__body}>
                    <div className={styles.sing_up__content__body__form}>
                        <div
                            className={
                                styles.sign_up__content__body__form__input_area
                            }
                        >
                            <TextField
                                className={
                                    styles.sign_up__content__body__form__input_area__input
                                }
                                size={'small'}
                                label={'First Name'}
                                name={'firstName'}
                        ...
                        <TextField
                            className={
                                styles.sign_up__content__body__form__username
                            }
                            size={'small'}
                            label={'Username'}
                            name={'username'}
                        ...
                        <div
                            className={
                                styles.sign_up__content__body__form__danger
                            }
                        >
                            This is just a clone app. Please do not use your
                            real google username and password!
                        </div>
                        <div
                            className={
                                styles.sign_up__content__body__form__input_area
                    ...
                    <figure className={styles.sing_up__content__body__image}>
                        ...
                        <figcaption
                            className={
                                styles.sing_up__content__body__image__caption
                            }
                        >
            ...
            <CardActions className={styles.sign_up__footer}>
                <Link to={'/sign-in'}>
                    <Button className={styles.sign_up__footer__button}>
                        Sign in instead
                    </Button>
                </Link>
                <Button
