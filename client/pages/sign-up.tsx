	...
	return (
		<GoogleCardLayout containerClassName={styles.sign_up__container} loading={loading}>
				...
				<div className={styles.sign_up__content__body}>
					<div className={styles.sing_up__content__body__form}>
						<div className={styles.sign_up__content__body__form__input_area}>
							<TextField
								...
								onChange={(e: ChangeEvent<HTMLInputElement>) =>
									setFormInput('firstName', 'value', e.target.value)
								}
								autoComplete={'off'}
							/>
							<TextField
								...
								onChange={(e: ChangeEvent<HTMLInputElement>) =>
									setFormInput('lastName', 'value', e.target.value)
								}
								autoComplete={'off'}
							/>
						</div>
						...
						<TextField
							...
							onChange={(e: ChangeEvent<HTMLInputElement>) =>
								setFormInput('username', 'value', e.target.value)
							}
							autoComplete={'off'}
							InputProps={{
								endAdornment: (
									<span style={{ paddingLeft: '8px' }}>@gmail.com</span>
								),
							}}
						/>
						{usernameHelperText}
						<div className={styles.sign_up__content__body__form__danger}>
							This is just a clone app. Please do not use your real google username
							and password!
						</div>
						<div className={styles.sign_up__content__body__form__input_area}>
							<TextField
								...
								onChange={(e: ChangeEvent<HTMLInputElement>) =>
									setFormInput('password', 'value', e.target.value)
								}
							...
							<TextField
								...
								onChange={(e: ChangeEvent<HTMLInputElement>) =>
									setFormInput('passwordConfirm', 'value', e.target.value)
								}
								type={showPassword ? 'text' : 'password'}
								autoComplete={'off'}
					...
					<figure className={styles.sing_up__content__body__image}>
						<img src={'/account.svg'} alt={'Google AccountPopup'} />
			...
			<CardActions className={styles.sign_up__footer}>
				<Link to={'/sign-in'}>
					<Button className={styles.sign_up__footer__button}>Sign in instead</Button>
				</Link>
				<Button
					variant={'contained'}
