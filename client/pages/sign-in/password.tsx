...
const Password = () => {
    ...
    return (
        <GoogleCardLayout
            containerClassName={styles.password__container}
            loading={loading}
        >
            <Helmet>
            ...
            <CardContent className={styles.password__content}>
                <div className={styles.password__content__header}>
                    ...
                    <div className={styles.password__content__header__texts}>
                        <div
                            className={
                                styles.password__content__header__texts__welcome
                            }
                        >
                            Welcome
                        </div>
                        <Link to={'/sign-in'}>
                            <Chip
                                className={
                                    styles.password__content__header__texts__chip
                                }
                                avatar={
                                    <Avatar>
                                        {params.username
            ...
            <CardActions className={styles.password__footer}>
                <Link to={'/just-clone'}>
                    <Button className={styles.password__footer__button}>
                        Forgot password?
                    </Button>
                </Link>
                <Button
