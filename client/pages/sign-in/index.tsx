...
const SignIn = () => {
    ...
    const { loading, username, usernameHelperText, handleSubmit, setUsername } =
        useSignIn();
    return (
        <GoogleCardLayout
        ...
        >
            ...
            <CardContent className={styles.sign_in__content}>
                <div className={styles.sign_in__content__header}>
                    ...
                    <div className={styles.sign_in__content__header__texts}>
                        <div
                            className={
                                styles.sign_in__content__header__texts__sign_in
                            }
                        >
                            Sign in
                        </div>
                        <div
                            className={
                                styles.sign_in__content__header__texts__continue
                            }
                        >
                ...
                <div className={styles.sign_in__content__body}>
                    ...
                    <div className={styles.sign_in__content__body__information}>
                        If you want to see just one form example without
                        registration,&nbsp;
            ...
            <CardActions className={styles.sign_in__footer}>
                <Link to={'/sign-up'}>
                    <Button className={styles.sign_in__footer__button}>
                        Create account
                    </Button>
                </Link>
                <Button
