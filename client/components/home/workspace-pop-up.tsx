        ...
        >
            ...
            >
                ...
                <div className={styles.workspace_pop_up__paper__tools}>
                    <div
                        className={
                            styles.workspace_pop_up__paper__tools__column
                        }
                    >
                ...
                <div className={styles.workspace_pop_up__paper__brand}>
                    ...
                    <div
                        className={
                            styles.workspace_pop_up__paper__brand__content
                        }
                    >
                        <p>Google Workspace</p>
                        <p>
                            An integrated suit of secure, cloud-native
                            collaboration and productivity apps powered by
                            Google AI.
                        </p>
                        <p>
                            <a
