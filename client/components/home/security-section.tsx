...
const SecuritySection = () => {
	return (
		<section id={'security'} className={styles.security_section}>
			<h2 className={styles.security_section__title}>Security, compliance, and privacy</h2>
			...
			<div className={styles.security_section__content}>
				<div className={styles.security_section__content__column}>
					...
					<p>
						We use industry-leading security measures to keep your data safe, including
						advanced malware protections. Forms is also cloud-native, eliminating the
						need for local files and minimizing risk to your devices.
					</p>
					<h3>Encryption in transit and at rest</h3>
					<p>
						All files uploaded to Google Drive or created in Forms are encrypted in
						transit and at rest.
					</p>
					<h3>Compliance to support regulatory requirements</h3>
					<p>
						Our products, including Forms, regularly undergo independent verification of
						their security, privacy, and{' '}
						<a
				...
				<div className={styles.security_section__content__column}>
					...
					<p>
						Forms adheres to the same robust privacy commitments and data protections as
						the rest of{' '}
						<a
