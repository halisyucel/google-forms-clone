			...
			<div className={styles.pricing_section__head}>
				...
				<div className={styles.pricing_section__head__includes}>
					...
					<ul>
						<li>
							<a
								href={'https://workspace.google.com/intl/en/products/docs/'}
								target={'_blank'}
						...
						<li>
							<a
								href={'https://workspace.google.com/intl/en/products/sheets/'}
								target={'_blank'}
								rel={'noopener noreferrer'}
							>
						...
						<li>
							<a
								href={'https://workspace.google.com/intl/en/products/slides/'}
								target={'_blank'}
								rel={'noopener noreferrer'}
							>
						...
						<li>
							<a
								href={'https://workspace.google.com/intl/en/products/forms/'}
								target={'_blank'}
								rel={'noopener noreferrer'}
							>
						...
						<li>
							<a
								href={'https://workspace.google.com/intl/en/products/keep/'}
								target={'_blank'}
								rel={'noopener noreferrer'}
							>
						...
						<li>
							<a
								href={'https://workspace.google.com/intl/en/products/sites/'}
								target={'_blank'}
								rel={'noopener noreferrer'}
							>
						...
						<li>
							<a
								href={'https://workspace.google.com/intl/en/products/drive/'}
								target={'_blank'}
								rel={'noopener noreferrer'}
							>
						...
						<li>
							<a
								href={'https://workspace.google.com/intl/en/products/gmail/'}
								target={'_blank'}
								rel={'noopener noreferrer'}
							>
						...
						<li>
							<a
								href={'https://workspace.google.com/intl/en/products/calendar/'}
								target={'_blank'}
								rel={'noopener noreferrer'}
							>
						...
						<li>
							<a
								href={'https://workspace.google.com/intl/en/products/chat/'}
								target={'_blank'}
								rel={'noopener noreferrer'}
							>
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td>
							<DoneIcon className={styles.pricing_section__table_icon__done} />
						</td>
						<td>
							<DoneIcon className={styles.pricing_section__table_icon__done} />
						</td>
					...
					<tr>
						...
						<td>
							<RemoveIcon className={styles.pricing_section__table_icon__remove} />
						</td>
						<td>
							<DoneIcon className={styles.pricing_section__table_icon__done} />
						</td>
