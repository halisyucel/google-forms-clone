            ...
            <List className={styles.drawer__list}>
                ...
                >
                    ...
                    >
                        <ListItemButton>
                            <ListItemIcon
                                className={styles.drawer__list__item_icon}
                            >
                                <img
                                    src={'/workspace-tool-docs.svg'}
                                    alt={'Google Docs'}
                                />
                            </ListItemIcon>
                            <ListItemText
