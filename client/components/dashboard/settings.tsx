...
import { Checkbox, Button, Dialog, DialogActions, DialogContent, DialogTitle } from '@mui/material';
...
const Settings = () => {
	...
	return (
		...
		>
			<DialogTitle className={styles.settings__title}>Settings</DialogTitle>
