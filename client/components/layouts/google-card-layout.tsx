...
const GoogleCardLayout = (props: GoogleCardLayoutProps) => {
    return (
        <div className={styles.google_global_layout}>
            <div
                className={`${styles.google_global_layout__container} ${props.containerClassName}`.trim()}
            >
                <Card
                    className={styles.google_global_layout__card}
                    variant={'outlined'}
                >
                    <LinearProgress
                        className={
                            styles.google_global_layout__card__linear_progress
                        }
                        style={{ display: props.loading ? 'block' : 'none' }}
                    />
                    <div
                        className={
                            styles.google_global_layout__card__loading_screen
                        }
                        style={{ display: props.loading ? 'block' : 'none' }}
                    />
                    {props.children}
                ...
                <div className={styles.google_global_layout__footer}>
                    ...
                    <Link
                        to={'/just-clone'}
                        className={styles.google_global_layout__footer__button}
                    >
                        Help
                    </Link>
                    <Link
